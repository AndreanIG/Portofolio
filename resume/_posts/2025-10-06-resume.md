...
**Machine Operator — Prima PMI, Melbourne, Australia** <small>Oct 2025 – Present</small>
- Operated industrial print-finishing machinery across **UV Lamination, Calender, and Guillotine** departments.
- Monitored UV lamination processes to ensure 100% coverage and quality standards for every page produced.
- Contributed to meeting high-volume production KPIs of **14,000 finished units** daily during peak seasonal demand.
- Performed routine technical maintenance and troubleshooting on feeders and sensors to minimize machine downtime.
- Utilized **RF scanning systems** for real-time job tracking, inventory control, and workflow coordination.
...
- **Microsoft Certified — Azure AI Engineer Associate (AI-102)** — Microsoft, *May 2024* - **Microsoft Certified — Azure AI Fundamentals (AI-900)** — Microsoft, *May 2024* - **Student Exchange Program** — Kaunas University of Technology, Lithuania, *Jan–Jul 2022* - **Learn with Google AI: Explore ML** — Google, *Mar 2022* - **Best Research Paper Award** — ICCSCI 2021, *Nov 2021* - **Finalist — SGU Mobile App Programming Competition** — Swiss German University, *Aug 2018* ---
